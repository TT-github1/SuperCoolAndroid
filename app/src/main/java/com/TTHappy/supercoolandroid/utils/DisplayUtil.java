package com.TTHappy.supercoolandroid.utils;
 ...
 * Update Date:
 * Modified By:
 * Description: <a href="https://juejin.im/post/5cf869aaf265da1b8b2b4e14">今日头条屏幕适配方案</a>
 */
...
//    private static float densityScale = 2.0f;
//
...
//     */
//    public static void setBitmapDefaultDensity(int defaultDensity) {
//        //获取单个变量的值
//        Class clazz;
//        try {
